...
<div class="row">
    <div class="col-md-12">
        ...
        <form role="form" method="post" action="{{ route('settings.resumecvcategories.update', $category->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="card">
                ...
                <div class="card-footer">
                    <div class="d-flex">
                        <a href="{{ route('settings.resumecvcategories.index') }}" class="btn btn-secondary">@lang('Cancel')</a>
