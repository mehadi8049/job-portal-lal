            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="title_seo" class="form-control" rows="4"></textarea>
                    </div>
                    <div class="form-group">
                        <label class="form-label">@lang('Meta description for SEO')</label>
                        <textarea name="description_seo" class="form-control" rows="4"></textarea>
                    </div>
                    <div class="form-group">
                        <label class="form-label">@lang('Meta keyword for SEO')</label>
                        <textarea name="keyword_seo" class="form-control" rows="4"></textarea>
                    </div>
                    <div class="form-group">
