@can('admin')
    ...
    <li class="nav-item">
        ...
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false"
            aria-controls="collapseTwo"><i class="fas fa-fw fa-cog"></i><span>@lang('Website settings')</span>
        </a>
        <div id="collapseTwo" class="collapse {{ in_array(routeName(), $sub_menu) ? 'show' : '' }}"
            ...
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item {{ routeName() == 'settings.index' ? 'active' : '' }}"
                    href="{{ route('settings.index') }}">
                    <span>@lang('General settings')</span>
                </a>
                <a class="collapse-item {{ routeName() == 'settings.manage-ads' ? 'active' : '' }}"
                    href="{{ route('settings.manage-ads') }}">
                    <span>@lang('Manage Ads')</span>
                </a>
                <a class="collapse-item {{ routeName() == 'settings.localization' ? 'active' : '' }}"
                ...
                <a class="collapse-item {{ routeName() == 'settings.email' ? 'active' : '' }}"
                    href="{{ route('settings.email') }}">
                    <span>@lang('E-mail Settings')</span>
                </a>
                <a class="collapse-item {{ routeName() == 'settings.integrations' ? 'active' : '' }}"
