...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
      <div>
        <a href="{{ route('settings.location.cities.create') }}" class="btn btn-primary">@lang('New City')</a>
      </div>
                    ...
                    <table class="table card-table table-vcenter text-nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('settings.location.cities.edit', ['id' => $item->id]) }}" class="btn btn-primary">@lang('Edit')</a>
                                    <form class="d-inline-block form-delete" action="{{ route('settings.location.cities.destroy', ['id' => $item->id]) }}" method="post" onsubmit="{{ 'return confirm(\''. __('Delete item ?') .'\')' }}">
                                        @csrf
                                        @method('DELETE')
